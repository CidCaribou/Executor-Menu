(function() {
    ...
    host.id = ID;
    host.style.cssText = 'all:initial;position:fixed;inset:auto 24px 24px auto;z-index:2147483647;';
  ...
  `;
    ...
    maxBtn.addEventListener('click', function(e) {
        ...
        if (!maximized) {
            ...
            hostEl.style.right = prevState.right || '24px';
            hostEl.style.bottom = prevState.bottom || '24px';
